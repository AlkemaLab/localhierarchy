...
Plots that show how values have been fixed in the local runs
...
And a plot to show the difference in estimates between global and local runs
...
```{r}
samples <- extract_parameter_subhierarchical(
        hierarchical_data = hier_data,
        subhierarchy = "iso",
        parname = "mu",
        fit_samples = fit1a$samples,
