...
We need to define the hierarchical levels to use, and the level of interest. Here we set level of interest to be equal to lowest level (iso), this is currently required (and the default setting in all runs in fit_model).
