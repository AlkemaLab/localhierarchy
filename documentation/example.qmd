...
Note that values of sigmas for higher levels are the same in the global national and subnational fit. However, mu_raws may be different if different countries were included or ordered differently. (this is documented inand reproducable with fit_global$geo_unit_index )
```{r}
