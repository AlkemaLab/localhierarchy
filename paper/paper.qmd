...
![Estimates of the level of demand for major world regions (top), smaller world regions (middle) and countries in Western Africa (bottom). Point estimates and 95% credible intervals are shown.](fig/hier_level.jpg){#fig-level width="685"}

![Estimates of the asymptote for demand for major world regions (top) and countries in Western Africa (bottom). Point estimates and 95% credible intervals are shown.](fig/hier_asymptote.jpg){#fig-asympt}
...
The simulation setup is summarized in Figure \ref{fig-simusetup}, top and center panels. Simulation of subnational data is discussed in a later section.
...
The column `name` includes the country names, given by simple indicares in this simulation. The column `quant` above refers to posterior means and upper and lower bounds of 95% credible intervals. We can create plots to show outputs, for example for the first 4 countries:
