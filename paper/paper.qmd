...
![Illustration of hierarchical grouping of countries in world regions.](fig/worldregions.jpg){#fig-hierstruc width="643"}
...
![General specification of a hierarchical model.](fig/hiermodel.jpg){#fig-hiermodel width="664"}
...
![Workflow for global and local national modeling.](fig/workflow.jpg){#fig-workflow width="677"}
...
![Diagram of simulation settings. Top: Hierarchical model for generating country and subnational parameters. Center: Data generating mechanism for national data, illustrated for the first country. Bottom: Data generating mechanism for subnational data, illustrated for the first subnational region (used only in Section 5).](fig/simusetup.jpg){#fig-simusetup width="682"}
...
![Workflow for nationally-informed global and local subnational modeling.](fig/nise.jpg){#fig-nise width="630"}
