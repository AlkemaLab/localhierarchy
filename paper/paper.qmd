...
<!-- #| fig-cap: "Estimates of the level of demand for countries in Western Africa and for higher levels used in the hierarchical model (smaller world regions and major world regions). Point estimates and 95% credible intervals are shown. " -->

<!-- plots$plot_reg_omega[[2]]/ plots$plot_reg_omega[[3]]/  plots$plot_iso_omega -->
...
<!-- #| fig-cap: "Estimates of the asymptote for demand for countries in Western Africa and for higher levels used in the hierarchical model (major world regions). Point estimates and 95% credible intervals are shown. " -->

<!-- plots$plot_reg_ptilde[[2]]  / plots$plot_iso_ptilde -->

<!-- ``` -->

![Estimates of the level of demand for countries in Western Africa and for higher levels used in the hierarchical model (smaller world regions and major world regions). Point estimates and 95% credible intervals are shown.](fig/hier_level.jpg){#fig-level width="685"}

![Estimates of the asymptote for demand for countries in Western Africa and for higher levels used in the hierarchical model (major world regions). Point estimates and 95% credible intervals are shown.](fig/hier_asymptote.jpg){#fig-asympt}
...
Figure @fig-subnatfits show illustrations of regional fits for Benin. The subnational model is fitted to all regional data from the country. @fig-subnatoverview illustrates fits in selected regions and differences across regions in 2024.
